...
SCRIPT = ROOT_DIR / "PT" / "PES_FootballLife_Asset_Downloader.py"
...
def main():
    ...
    if not SCRIPT.exists():
        return fail(f"Asset Downloader script not found:\n{SCRIPT}")
    ...
    try:
        ...
        return fail(f"Failed to start the Asset Downloader:\n{exc}")
