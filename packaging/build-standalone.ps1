...
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("numpy")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("matplotlib")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("PIL")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("moderngl")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("glfw")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("panda3d")
$bridgeArgs.Add("--collect-all"); $bridgeArgs.Add("ursina")
